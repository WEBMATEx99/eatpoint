...
<html lang="en">
  ...
  <body>
    ...
    <section class="dishes">
        <div class="dishes-parallax">
            <div class="dishes-overlay"></div>
            <div class="dishes-content">
                
                <div class="dishes-stats">
                    <div class="stat-item">
                        <span class="stat-number">50+</span>
                        <span class="stat-label" style="color: white;">Unique Dishes</span>
                    </div>
                    <div class="stat-item">
                        <span class="stat-number">12</span>
                        <span class="stat-label" style="color: white;">Cuisine Types</span>
                    </div>
                    <div class="stat-item">
                        <span class="stat-number">100%</span>
                        <span class="stat-label" style="color: white; ">Fresh Ingredients</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="dishes-grid">
                <div class="dishes-card">
                    <div class="dishes-image">
                        <img src="https://images.pexels.com/photos/1640777/pexels-photo-1640777.jpeg" alt="Italian Cuisine">
                        <div class="dishes-overlay-card"></div>
                    </div>
                    <div class="dishes-info">
                        <h3>Italian Cuisine</h3>
                        <p>Authentic Italian flavors with fresh ingredients</p>
                        <a href="menu.php" class="dishes-btn">Explore Menu</a>
                    </div>
                </div>

                <div class="dishes-card">
                    <div class="dishes-image">
                        <img src="https://images.pexels.com/photos/2097090/pexels-photo-2097090.jpeg" alt="Japanese Cuisine">
                        <div class="dishes-overlay-card"></div>
                    </div>
                    <div class="dishes-info">
                        <h3>Japanese Cuisine</h3>
                        <p>Traditional Japanese dishes with modern twists</p>
                        <a href="menu.php" class="dishes-btn">Explore Menu</a>
                    </div>
                </div>
                ...
                <div class="dishes-card">
                    <div class="dishes-image">
                        <img src="https://images.pexels.com/photos/2474661/pexels-photo-2474661.jpeg" alt="Indian Cuisine">
                        <div class="dishes-overlay-card"></div>
                    </div>
                    <div class="dishes-info">
                        <h3>Indian Cuisine</h3>
                        <p>Rich and aromatic Indian specialties</p>
                        <a href="menu.php" class="dishes-btn">Explore Menu</a>
                    </div>
                </div>
                ...
                <div class="dishes-card">
                    <div class="dishes-image">
                        <img src="https://images.pexels.com/photos/461198/pexels-photo-461198.jpeg" alt="Mexican Cuisine">
                        <div class="dishes-overlay-card"></div>
                    </div>
                    <div class="dishes-info">
                        <h3>Mexican Cuisine</h3>
                        <p>Spicy and flavorful Mexican delights</p>
                        <a href="menu.php" class="dishes-btn">Explore Menu</a>
                    </div>
                </div>
        ...
        <div class="dishes-features">
            <div class="dishes-feature">
            ...
            <div class="dishes-feature">
                ...
                <h4>Quick Service</h4>
                <p>Fast and efficient service guaranteed</p>
            </div>
            <div class="dishes-feature">
                <i class="fas fa-star"></i>
                <h4>Premium Quality</h4>
                <p>Experience the highest quality dining</p>
            </div>
        </div>
    </section>
